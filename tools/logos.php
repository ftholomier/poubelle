 ...
 *
 * Produit :
 *   logo-villard.png          logo complet détouré, marges égalisées
 *   logo-villard-clair.png    mot-symbole en ivoire, pour les fonds sombres
 *   embleme-villard.png       monogramme seul, pour les usages compacts
 *   favicon-512.png           monogramme sur fond magenta
 *
...
imagepng($complet, $destination . '/logo-villard.png', 9);
printf("logo-villard.png %dx%d\n", imagesx($complet), imagesy($complet));
...
imagepng($embleme, $destination . '/embleme-villard.png', 9);
printf("embleme-villard.png %dx%d\n", imagesx($embleme), imagesy($embleme));

// --- variante claire ------------------------------------------------------
// Sur fond sombre, le mot-symbole magenta tombe à 3:1 : illisible en petit.
...
imagepng($clair, $destination . '/logo-villard-clair.png', 9);
printf("logo-villard-clair.png %dx%d\n", imagesx($clair), imagesy($clair));
...
foreach ([400, 800] as $l) {
    ...
    imagepng($petit, $destination . '/logo-villard@' . $l . '.png', 9);
    printf("logo-villard@%d.png %dx%d\n", $l, $l, $h);
}
