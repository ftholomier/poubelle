        ...
        <div className="panel">
          ...
          {list.length ? (
            ...
            <p style={{ margin: 0, fontSize: 14, color: 'var(--muted)' }}>
              Vous n&apos;avez pas encore publié d&apos;offre. Elles apparaissent sur votre fiche et la page Emploi du territoire.
            </p>
          )}
        </div>
        {showForm ? (
          <ActionForm action={saveJob} className="panel" resetOnSuccess={!editing}>
            ...
            <textarea
              ...
              defaultValue={editing?.missions.join('\n') ?? ''}
              maxLength={3000}
            />
            <textarea
              name="profile"
              ...
              defaultValue={editing?.profile.join('\n') ?? ''}
              maxLength={3000}
            />
            <input
              name="applyEmail"
              ...
              defaultValue={editing?.applyEmail ?? ''}
            />
