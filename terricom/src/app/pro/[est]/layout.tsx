...
export default async function ProAppLayout({ children, params }: Props) {
  ...
  const items: NavItem[] = [
    ...
    { href: `${base}/site`, label: 'Mini-site & formulaires' },
    { href: `${base}/synchronisation`, label: 'Synchronisation' },
    ...(ctx.role !== 'STAFF' ? [{ href: `${base}/clients`, label: 'Clients' }] : []),
  ...
  const titles: [string, string][] = [
    ...
    [`${base}/site`, 'Mini-site, pages et formulaires'],
    [`${base}/synchronisation`, 'Synchronisation des contenus'],
    [`${base}/clients`, 'Clients abonnés'],
