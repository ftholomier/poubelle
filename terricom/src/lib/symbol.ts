 ...
 */
export const SYMBOL_PATH = 'M-0.5 0.36L-0.5 0A0.5 0.5 0 0 1 0 -0.5A0.5 0.5 0 0 1 0.5 0A0.5 0.5 0 0 1 0 0.5L-0.36 0.5A0.14 0.14 0 0 1 -0.5 0.36Z';

/** SVG autonome du symbole (favicon, icônes, documents imprimés). */
export function symbolSvg(
  opts: { size?: number; bg?: string | null; mark?: string; letter?: string | null; letterColor?: string; radius?: number } = {},
): string {
