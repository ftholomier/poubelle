...
$router->get('/admin/societe',  $protege(fn() => $edition->societe()));
$router->post('/admin/societe', $protege(fn() => $edition->societeEnvoi()));

// --- services (collection avec fiche par service) -------------------------
$router->get('/admin/services',              $protege(fn() => $edition->services()));
$router->post('/admin/services/entete',      $protege(fn() => $edition->servicesIntroEnvoi()));
$router->post('/admin/services/creer',       $protege(fn() => $edition->serviceCreer()));
$router->post('/admin/services/{slug}/publication', $protege(fn(array $p) => $edition->servicePublication($p['slug'])));
$router->post('/admin/services/{slug}/ordre',       $protege(fn(array $p) => $edition->serviceOrdre($p['slug'])));
$router->post('/admin/services/{slug}/supprimer',   $protege(fn(array $p) => $edition->serviceSupprimer($p['slug'])));
$router->get('/admin/services/{slug}',       $protege(fn(array $p) => $edition->service($p['slug'])));
$router->post('/admin/services/{slug}',      $protege(fn(array $p) => $edition->serviceEnvoi($p['slug'])));

// --- valeurs --------------------------------------------------------------
$router->get('/admin/valeurs',               $protege(fn() => $edition->valeurs()));
$router->post('/admin/valeurs',              $protege(fn() => $edition->valeursEnvoi()));
$router->post('/admin/valeurs/entete',       $protege(fn() => $edition->valeursIntroEnvoi()));
$router->post('/admin/valeurs/creer',        $protege(fn() => $edition->valeurCreer()));
$router->post('/admin/valeurs/{slug}/publication', $protege(fn(array $p) => $edition->valeurPublication($p['slug'])));
...
// --- devis et contact -----------------------------------------------------
$router->get('/admin/devis',    $protege(fn() => $edition->devis()));
$router->post('/admin/devis',   $protege(fn() => $edition->devisEnvoi()));
