...
<title><?= e($page['titre'] ?? 'Administration') ?> — Back-office Baron Paysage</title>
...
<div class="bo-cadre">
  <aside class="bo-lateral">
    <a class="bo-lateral__logo" href="<?= url('/admin') ?>">
      <img src="<?= asset('assets/img/logo/logo-baron-clair.svg') ?>" alt="Baron Paysage — back-office">
    </a>
