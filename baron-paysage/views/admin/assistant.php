...
<div class="bo-bloc">
  <h2>Source 3 — notes de l’entreprise</h2>
  <p class="bo-aide">
...
<div class="bo-bloc">
  ...
  <form class="bo-form bo-form--inline" method="post" action="<?= url('/admin/assistant/essai') ?>">
    ...
    <div class="bo-champ">
      ...
      <input id="ia-essai" type="text" name="question" placeholder="Intervenez-vous à Belfort pour un entretien de jardin ?" required>
    </div>
