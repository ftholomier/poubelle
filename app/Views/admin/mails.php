...
<div class="panel">
  <p class="panel__intro">
    ...
    <a href="<?= e(url('admin/reglages')) ?>" class="souligne">Réglages</a>. Le contenu des envois récents reste consultable.
  </p>
  <?php if (!$rows): ?>
      ...
      <table class="data">
        ...
        <tbody>
          <?php foreach ($rows as $m): ?>
            <tr>
              <td><?= e($m['to'] ?? '') ?></td>
              <td class="txt-attenue"><?= e($m['subject'] ?? '') ?></td>
              <td>
              ...
              <td class="txt-attenue nowrap"><?= e($m['transport'] ?? '—') ?></td>
              <td class="txt-attenue nowrap"><?= e(fr_date($m['created_at'] ?? '', true)) ?></td>
            </tr>
          <?php endforeach; ?>
        </tbody>
      </table>
