...
return [
    ...
    // --- Les métiers --------------------------------------------------------
    'trades.title'        => 'Les métiers du spectacle, de l’audiovisuel et de l’événementiel',
    'trades.lede'         => '%d fiches pour découvrir les métiers du spectacle vivant, du cinéma, de la télévision et de l’événementiel : missions, formation, statut d’intermittent, salaire indicatif et offres d’emploi du moment.',
    'trades.meta'         => 'Fiches métiers du spectacle, de l’audiovisuel et de l’événementiel : missions, formation, intermittence, salaire indicatif et offres d’emploi pour %d métiers.',
    'trades.jump'         => 'Aller à une famille de métiers',
    'trades.job_one'      => '1 offre',
    'trades.job_many'     => '%d offres',
    'trades.cta_title'    => 'Votre métier est dans la liste ?',
    'trades.cta_note'     => 'Déposez votre CV gratuitement, ou publiez une annonce si vous recrutez : les deux sont gratuits.',
    'trade.kicker'        => 'Fiche métier',
    'trade.seo_title'     => '%s : missions, salaire et formation',
    'trade.back'          => 'Tous les métiers',
    'trade.h_missions'    => 'Que fait un %s ?',
    'trade.h_day'         => 'Une journée type',
    'trade.h_skills'      => 'Compétences et qualités',
    'trade.h_training'    => 'Comment devenir %s ?',
    'trade.h_schools'     => 'Formations et écoles',
    ...
    'trade.brief'         => 'En bref',
    'trade.brief_pay'     => 'Rémunération',
    'trade.brief_status'  => 'Statut',
    'trade.brief_training'=> 'Formation',
    'trade.brief_sectors' => 'Secteurs',
    'trade.brief_rome'    => 'Code ROME',
    'trade.brief_f'       => 'Au féminin',
    'trade.see_jobs'      => 'Voir les offres',
    'trade.post_cv'       => 'Déposer mon CV',
    'trade.cta_cv_title'  => 'Vous êtes %s ?',
    'trade.cta_cv_note'   => 'Déposez votre CV gratuitement : les employeurs du spectacle consultent l’annuaire chaque jour.',
    'trade.cta_job_title' => 'Vous recrutez ?',
    'trade.cta_job_note'  => 'Publiez votre annonce gratuitement : elle apparaîtra aussi sur cette fiche.',
    'trade.family_more'   => 'Famille %s',
];
