...
final class Seo
{
    ...
    public const PAGES = [
        ...
        'le-cabinet'       => ['slug' => 'le-cabinet',       'nom' => 'Le cabinet'],
    ...
    private const CONTENUS = [
        ...
        'pages/accueil', 'pages/le-cabinet', 'pages/nos-services',
    ...
    private function noeudDomaine(array $site, string $base, string $id, callable $media): array
    {
        ...
        $noeud = [
            // AccountingService décrit précisément le métier ; c'est un
    ...
    private function noeudFiche(string $cle, array $item, string $base, string $domaine, callable $media): array
    {
        ...
        return [
            ...
            'areaServed'  => ['@type' => 'AdministrativeArea', 'name' => 'Doubs et Franche-Comté'],
        ];
    }
