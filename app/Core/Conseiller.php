...
final class Conseiller
{
    ...
    private function consigne(): string
    {
        ...
        return implode("\n", [
            ...
            '',
            'QUAND TU PROPOSES UN TEXTE, écris-le dans un bloc de cette forme exacte, et rien d’autre dedans :',
            '```proposition',
            'le texte proposé, prêt à être collé',
            '```',
            'Le back-office affiche alors un bouton qui pose ce texte dans le champ. Un titre de page vise 60 caractères, une description de référencement entre 120 et 158.',
            '',
