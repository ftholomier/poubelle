...
final class Seo
{
    ...
    public const PAGES = [
        ...
        'conseil-municipal' => ['slug' => 'conseil-municipal',            'nom' => 'Conseil municipal'],
        ...
        'histoire'          => ['slug' => 'histoire-du-village',          'nom' => 'Histoire du village'],
        'associations'      => ['slug' => 'associations',                 'nom' => 'Associations'],
        'actualites'        => ['slug' => 'actualites',                   'nom' => 'Actualités'],
        'agenda'            => ['slug' => 'agenda',                       'nom' => 'Agenda'],
        'flash-info'        => ['slug' => 'flash-info',                   'nom' => 'Flash Info'],

        // --- vie pratique ------------------------------------------------
        'vie-pratique'      => ['slug' => 'vie-pratique',                 'nom' => 'Vie pratique'],
        'dechets'           => ['slug' => 'gerer-mes-dechets',            'nom' => 'Gérer mes déchets'],
        'eau'               => ['slug' => 'eau-et-assainissement',        'nom' => 'Eau & assainissement'],
    ...
    private const CONTENUS = [
        ...
        'pages/accueil', 'pages/la-mairie', 'pages/conseil-municipal',
        'pages/commissions', 'pages/comptes-rendus', 'pages/budget',
        'pages/urbanisme', 'pages/demarches', 'pages/demarches-en-ligne',
        'pages/services-etat', 'pages/ccas', 'pages/vie-scolaire',
        'pages/le-village', 'pages/histoire', 'pages/associations',
        'pages/actualites', 'pages/agenda', 'pages/flash-info',
        'pages/vie-pratique', 'pages/dechets', 'pages/eau',
        'pages/intercommunalite', 'pages/numeros-utiles', 'pages/demande',
        'pages/contact', 'pages/mentions-legales', 'pages/confidentialite',
    ...
    private function noeudFiche(string $cle, array $item, string $base, string $commune, callable $media): array
    {
        ...
        return [
            ...
            'areaServed'     => ['@type' => 'AdministrativeArea', 'name' => 'Lachapelle-sous-Chaux'],
