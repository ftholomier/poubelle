...
<section class="section avis">
  <div class="conteneur">
    <div class="avis__tete reveler">
      <p class="surtitre"><?= e(t('Avis Google')) ?></p>
      <h2 class="titre-section"><?= e(t('Ce que disent les visiteurs')) ?></h2>
    ...
    <div class="avis__carrousel" data-avis data-pause="<?= e($pause) ?>">
      ...
      <ul class="avis__piste" tabindex="0" aria-label="<?= e(t('Avis laissés sur la fiche Google de la mairie')) ?>">
