...
<title><?= e($page['titre'] ?? 'Administration') ?> — Back-office Cabinet Villard</title>
...
<div class="bo-cadre">
  <aside class="bo-lateral">
    <a class="bo-lateral__logo" href="<?= url('/admin') ?>">
      <img src="<?= asset('assets/img/logo/logo-villard-clair.png') ?>" alt="Cabinet Villard — back-office">
    </a>
