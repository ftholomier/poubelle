...
<title><?= e($page['titre'] ?? 'Administration') ?> — Back-office Étang Fourchu</title>
...
<div class="bo-cadre">
  <aside class="bo-lateral">
    <a class="bo-lateral__logo" href="<?= url('/admin') ?>">
      <img src="<?= asset('assets/img/logo/logo-etang-fourchu.svg') ?>" alt="Étang Fourchu — back-office">
    </a>
