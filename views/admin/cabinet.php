...
use App\Core\Csrf;
?>
<form class="bo-form" method="post" action="<?= url('/admin/cabinet') ?>" enctype="multipart/form-data">
  <?= Csrf::champ() ?>
  ...
  <fieldset>
    ...
    <div class="bo-rangee">
      <div class="bo-champ">
        ...
        <input id="c-hsur" type="text" name="hero_surtitre" value="<?= e($cabinet['hero']['surtitre']) ?>">
      </div>
      <div class="bo-champ">
        <label for="c-htit">Titre principal (H1)</label>
        <input id="c-htit" type="text" name="hero_titre" value="<?= e($cabinet['hero']['titre']) ?>">
      </div>
    </div>
    <div class="bo-champ">
      <label for="c-htex">Texte d’introduction</label>
      <textarea id="c-htex" name="hero_texte" rows="3"><?= e($cabinet['hero']['texte']) ?></textarea>
    </div>
    <div class="bo-champ">
      <label>Photo du bandeau</label>
      <?= $view->partial('admin/choix-photo', [
          'medias' => $medias, 'nom' => 'hero_image', 'id' => 'chero',
          'choisie' => $cabinet['hero']['image'], 'vide' => '',
      ]) ?>
    </div>
  </fieldset>
  ...
  <fieldset>
    ...
    <div class="bo-rangee">
      <div class="bo-champ">
        ...
        <input id="c-isur" type="text" name="histoire_surtitre" value="<?= e($cabinet['histoire']['surtitre']) ?>">
      </div>
      <div class="bo-champ">
        <label for="c-itit">Titre</label>
        <input id="c-itit" type="text" name="histoire_titre" value="<?= e($cabinet['histoire']['titre']) ?>">
      </div>
    </div>
    <div class="bo-champ">
      <label for="c-itex">Texte</label>
      <textarea id="c-itex" name="histoire_texte" rows="6"><?= e(implode("\n\n", $cabinet['histoire']['paragraphes'])) ?></textarea>
      <p class="bo-aide">Une ligne vide sépare deux paragraphes.</p>
    </div>
  </fieldset>

  <?php foreach ($cabinet['piliers']['items'] as $i => $pilier): ?>
    <fieldset>
  ...
  <fieldset>
    ...
    <div class="bo-rangee">
      <div class="bo-champ">
        ...
        <input id="c-clsur" type="text" name="clients_surtitre" value="<?= e($cabinet['clients']['surtitre']) ?>">
      </div>
      <div class="bo-champ">
        <label for="c-cltit">Titre</label>
        <input id="c-cltit" type="text" name="clients_titre" value="<?= e($cabinet['clients']['titre']) ?>">
      </div>
    </div>
    <div class="bo-champ">
      <label for="c-cltex">Texte</label>
      <textarea id="c-cltex" name="clients_texte" rows="2"><?= e($cabinet['clients']['texte']) ?></textarea>
    </div>

    <?php foreach ($cabinet['clients']['items'] as $i => $client): ?>
      <div class="bo-rangee">
        <div class="bo-champ">
    ...
    <p class="bo-aide">
      ...
      l’<a href="<?= url('/admin/avance?nom=pages/le-cabinet') ?>">Éditeur avancé</a>.
    </p>
  </fieldset>
  ...
  <fieldset>
    ...
    <div class="bo-rangee">
      <div class="bo-champ">
        ...
        <input id="c-esur" type="text" name="engagement_surtitre" value="<?= e($cabinet['engagement']['surtitre']) ?>">
      </div>
      <div class="bo-champ">
        <label for="c-etit">Titre</label>
        <input id="c-etit" type="text" name="engagement_titre" value="<?= e($cabinet['engagement']['titre']) ?>">
      </div>
    </div>
    <div class="bo-champ">
      <label for="c-etex">Texte</label>
      <textarea id="c-etex" name="engagement_texte" rows="5"><?= e(implode("\n\n", $cabinet['engagement']['paragraphes'])) ?></textarea>
    </div>
  </fieldset>
  ...
  <fieldset>
    ...
    <div class="bo-champ">
      ...
      <textarea id="c-meta" name="meta_description" rows="2"><?= e($cabinet['meta']['description'] ?? '') ?></textarea>
    </div>
  </fieldset>
