    ...
    <div class="bo-rangee">
      <div class="bo-champ">
        ...
        <input id="p-dest" type="email" name="destinataire" value="<?= e($contact['destinataire']) ?>"
               placeholder="contact@menuiserietrehant.fr">
        <span class="aide">
  ...
  <fieldset>
    ...
    <div class="bo-rangee">
      <div class="bo-champ">
        ...
        <input id="p-hote" type="text" name="hote" value="<?= e($smtp['hote']) ?>" placeholder="mail.menuiserietrehant.fr">
      </div>
      <div class="bo-champ">
    ...
    <div class="bo-rangee">
      <div class="bo-champ">
        ...
        <input id="p-id" type="text" name="identifiant" value="<?= e($smtp['identifiant']) ?>"
               autocomplete="off" placeholder="contact@menuiserietrehant.fr">
      </div>
      <div class="bo-champ">
