...
<title><?= e($page['titre'] ?? 'Administration') ?> — Mairie d’Angeot</title>
...
<main class="bo-carte-acces">
  <img class="bo-carte-acces__logo" src="<?= asset('assets/img/logo/logo-angeot-clair.svg') ?>" alt="Mairie d’Angeot">
  <?= $slot ?>
</main>
</body>
</html>
