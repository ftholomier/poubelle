...
<title><?= e($page['titre'] ?? 'Administration') ?> — Menuiserie Tréhant</title>
...
<main class="bo-carte-acces">
  <img class="bo-carte-acces__logo" src="<?= asset('assets/img/logo/logo-trehant.png') ?>" alt="Menuiserie Tréhant">
  <?= $slot ?>
</main>
</body>
</html>
