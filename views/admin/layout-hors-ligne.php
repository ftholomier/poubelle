...
<title><?= e($page['titre'] ?? 'Administration') ?> — Étang Fourchu</title>
...
<main class="bo-carte-acces">
  <img class="bo-carte-acces__logo" src="<?= asset('assets/img/logo/logo-etang-fourchu.svg') ?>" alt="Étang Fourchu">
  <?= $slot ?>
</main>
</body>
</html>
