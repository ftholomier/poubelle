...
<div class="bo-bloc">
  ...
  <p class="bo-aide">Indiquez le nom du cabinet et sa ville. La clé d’API doit être enregistrée au préalable.</p>
  <form class="bo-form bo-form--inline" method="post" action="<?= url('/admin/avis/rechercher') ?>">
    ...
    <div class="bo-champ">
      ...
      <input id="a-recherche" type="text" name="recherche"
             placeholder="Cabinet Villard, Colombier Fontaine">
    </div>
