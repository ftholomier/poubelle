...
<div class="cookies" data-cookies hidden>
  ...
  <div class="cookies__bandeau" data-cookies-bandeau role="dialog"
    ...
    <div class="cookies__actions">
      <button class="btn btn--orange" type="button" data-cookies-tout><?= e(t('Tout accepter')) ?></button>
      <button class="btn btn--orange" type="button" data-cookies-rien><?= e(t('Tout refuser')) ?></button>
  ...
  <div class="cookies__panneau" data-cookies-panneau hidden role="dialog" aria-modal="true"
    ...
    <div class="cookies__panneau-pied">
      <button class="btn btn--orange" type="button" data-cookies-rien><?= e(t('Tout refuser')) ?></button>
      <button class="btn btn--orange" type="button" data-cookies-tout><?= e(t('Tout accepter')) ?></button>
      <button class="btn btn--orange" type="button" data-cookies-enregistrer><?= e(t('Enregistrer mes choix')) ?></button>
    </div>
  </div>
</div>
