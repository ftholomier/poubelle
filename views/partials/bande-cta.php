...
<section class="bande-cta" style="background-image:url('<?= asset('assets/img/site/image-12-1.jpg') ?>')">
  <div class="conteneur reveler">
    <p class="surtitre surtitre--centre">Réservation</p>
    <h2 class="bande-cta__titre">Votre séjour nature commence ici</h2>
    <p>Entre étang, forêt et grand air, découvrez un lieu pensé pour se ressourcer. Des hébergements tout équipés et accessibles vous attendent, avec spa privatif et un environnement préservé, pour un moment de calme et de déconnexion.</p>
